...
export function ManagementInspector({
  ...
  if (!card) {
    return (
      <aside className="h-full rounded-[22px] border border-slate-200 bg-white p-4 shadow-sm">
  ...
  return (
    <aside className="h-full min-h-0 overflow-y-auto rounded-[22px] border border-slate-200 bg-white p-4 shadow-sm">
