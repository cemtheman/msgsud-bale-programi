...
export function ManagementBusyOverlay({
  ...
  return (
    <div
      ...
      aria-busy="true"
    >
      <div className="flex min-w-[250px] flex-col items-center rounded-[28px] border border-white/80 bg-white/95 px-8 py-7 text-center shadow-[0_28px_90px_rgba(15,23,42,0.22)]">
